    ...
    <div class="container fade-in" style="max-width: 640px;">
        ...
        <div class="mb-4">
            ...
            <p class="text-white-50 mt-2 mb-0">
                Mengedit divisi: <strong class="text-white">{{ $divisi->nama }}</strong>
                <span class="badge-kode ms-2">{{ $divisi->kode }}</span>
            </p>
        </div>
                ...
                <div class="input-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="kode" id="kode" class="form-control-modern"
                            placeholder="Contoh: IT, HR, FIN" value="{{ old('kode', $divisi->kode) }}" required
